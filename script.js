...
const translations = {
    es: {
        ...
        rag: {
            tag: "// Proyecto",
            title: "RAG: la IA que responde <span class=\"text-gradient\">con tus datos</span>",
            subtitle: "Asistentes que antes de contestar consultan los documentos reales de tu empresa — manuales, catálogos, contratos, políticas — y responden con fuentes, sin inventarse nada.",
            whatH: "¿Qué es RAG?",
            p1: "<strong>RAG</strong> son las siglas de <em>Retrieval-Augmented Generation</em> (generación aumentada por recuperación). Es la técnica que convierte un chatbot genérico en un asistente que conoce <strong>tu</strong> negocio.",
            quote: "La forma más fácil de entenderlo: un chatbot normal hace el examen <em>de memoria</em>; un asistente con RAG lo hace <em>con tu libro abierto delante</em>. Antes de responder, busca en tus documentos y redacta la respuesta a partir de lo que encuentra.",
            p2: "ChatGPT o Claude \"a pelo\" saben mucho del mundo en general, pero no saben nada de tus precios, tus plazos de entrega, tu convenio o tu manual interno. Y cuando no saben algo, tienden a rellenar el hueco con una respuesta que <em>suena</em> bien — lo que se conoce como alucinación. En una empresa eso es inaceptable: un precio inventado o una cláusula mal citada cuestan dinero.",
            howH: "Cómo funciona",
            s1t: "Se indexan tus documentos",
            s1p: "Manuales, catálogos, PDFs, webs, hojas de cálculo… se trocean y se convierten en representaciones matemáticas (embeddings) guardadas en una base de datos vectorial. Tus documentos no se usan para entrenar modelos de terceros.",
            s2t: "Cada pregunta busca primero",
            s2p: "Cuando alguien pregunta, el sistema recupera los fragmentos de tus documentos más relevantes para esa pregunta concreta — aunque esté formulada con otras palabras.",
            s3t: "La IA responde con fuentes",
            s3p: "El modelo redacta la respuesta usando solo esos fragmentos y puede citar de qué documento y página sale cada dato. Si la información no existe, dice que no la tiene en vez de inventarla.",
            vsH: "Qué aporta frente a un chatbot normal",
            vsBadT: "❌ Chatbot genérico",
            vsBadList: "<li>Responde de memoria: puede inventar precios, plazos o políticas.</li><li>No conoce tu negocio ni tus documentos internos.</li><li>Su conocimiento se congeló el día que se entrenó el modelo.</li><li>Imposible auditar de dónde salió una respuesta.</li>",
            vsGoodT: "✅ Asistente con RAG",
            vsGoodList: "<li>Responde a partir de tus documentos reales, con cita de la fuente.</li><li>Conoce tu catálogo, tus tarifas y tus procedimientos al detalle.</li><li>¿Cambia una tarifa? Subes el documento nuevo y ya responde con él.</li><li>Cada respuesta es trazable: sabes qué documento la respalda.</li>",
            benH: "Beneficios para tu empresa",
            b1t: "Respuestas fiables",
            b1p: "Sin alucinaciones: si no está en tus documentos, el asistente lo dice.",
            b2t: "Datos protegidos",
            b2p: "Tu información se consulta, no se usa para entrenar modelos de terceros.",
            b3t: "Siempre actualizado",
            b3p: "Actualizar el asistente es subir un documento — sin reentrenar nada.",
            b4t: "Ahorro real de tiempo",
            b4p: "Las preguntas repetitivas de clientes y empleados se responden solas, 24/7.",
            b5t: "Multi-idioma",
            b5p: "Tus documentos en español; respuestas en catalán, francés o inglés.",
            b6t: "Con fuentes",
            b6p: "Cada respuesta indica el documento y apartado del que sale.",
            casesH: "Casos de uso típicos",
            c1t: "Atención al cliente",
            c1p: "Responde dudas de productos, envíos, devoluciones y garantías consultando tu catálogo y tus políticas reales.",
            c2t: "Asistente interno para empleados",
            c2p: "\"¿Cuántos días de vacaciones me quedan según el convenio?\" — respuesta al momento consultando RRHH, manuales y procedimientos.",
            c3t: "Documentación legal y normativa",
            c3p: "Busca en contratos, normativas y pólizas citando el artículo exacto — en vez de leer 200 páginas.",
            c4t: "Inmobiliarias y catálogos grandes",
            c4p: "\"Piso de 2 habitaciones con terraza por menos de 250.000€\" — busca en tu cartera real y responde con las fichas.",
            c5t: "Formación y soporte técnico",
            ...
            rolesH: "Permisos por rol: cada empleado ve solo lo suyo",
            rolesP1: "Al cargar toda la documentación de una empresa surge la pregunta obligada: ¿puede cualquier empleado consultar cualquier documento? No. Cada documento se etiqueta con los roles que pueden verlo — todos, un departamento, solo dirección — y el asistente responde a cada usuario únicamente con los documentos de su nivel de acceso.",
            rolesQ: "Misma pregunta — «¿Cuál es la banda salarial de recepción?» — dos respuestas distintas según quién pregunta:",
            rolesA1t: "🛎️ Preguntando como Recepción",
            rolesA1: "«Esa información no está en los documentos disponibles para tu rol.» El informe de dirección ni siquiera llega al modelo, así que no hay nada que pueda filtrarse.",
            rolesA2t: "🔑 Preguntando como Dirección",
            rolesA2: "«La banda salarial del personal de recepción va de 22.000 a 27.000 € brutos anuales…» — con cita del informe interno que la respalda.",
            rolesP2: "La clave es dónde se aplica el filtro: antes de la IA, en la propia búsqueda. Lo que un rol no puede ver nunca entra en el contexto del modelo, así que no se le puede «convencer» para que lo revele — no es una instrucción que se pueda saltar, es que no lo tiene. Los permisos pueden heredarse de los que ya usas en Google Drive, SharePoint o tu intranet, y cada consulta queda registrada para auditoría. <a href=\"demo-rag.html\">Compruébalo tú mismo en la demo cambiando de rol</a>.",
...
about: {
        ...
        blog: {
            ...
            post1: {
                date: '24 Jun 2026',
                excerpt: 'Rangos de precio reales, los factores que encarecen un proyecto y cómo comparar presupuestos sin sustos.',
                readMore: 'Leer más →',
                title: 'Cuánto cuesta una app en 2026 (y de qué depende)',
            },
            post2: {
                date: '17 Jun 2026',
                excerpt: 'Las tareas que tu negocio repite a mano se pueden hacer solas. Estas son las que más tiempo devuelven.',
                readMore: 'Leer más →',
                title: 'Automatizaciones que ahorran horas cada semana',
            },
            post3: {
                date: '10 Jun 2026',
                excerpt: 'Instagram no es tuyo. Lo que una web propia aporta en reservas sin comisiones y clientes que sí lo son.',
                readMore: 'Leer más →',
                title: 'Por qué tu restaurante necesita web propia',
            },
            post4: {
                date: '3 Jun 2026',
                excerpt: 'La mitad de los proyectos empiezan pidiendo lo que no necesitan. Guía honesta para elegir sin pagar de más.',
                readMore: 'Leer más →',
                title: '¿Web, app o programa a medida? Qué necesitas de verdad',
            },
            post5: {
                date: '27 May 2026',
                excerpt: 'Cada reserva por Booking te cuesta hasta un 25%. Lo que hace que el huésped reserve directo en tu web.',
                readMore: 'Leer más →',
                title: 'Webs de hotel que convierten visitas en reservas directas',
            },
            post6: {
                date: '20 May 2026',
                excerpt: 'El comprador decide qué visitar desde el sofá. Las herramientas digitales que marcan la diferencia hoy.',
                readMore: 'Leer más →',
                title: 'Visitas virtuales e IA: así se venden pisos en 2026',
            },
        },
        contact: {
            contactInfo: {
    ...
    ca: {
        ...
        rag: {
            tag: "// Projecte",
            title: "RAG: la IA que respon <span class=\"text-gradient\">amb les teves dades</span>",
            subtitle: "Assistents que abans de contestar consulten els documents reals de la teva empresa — manuals, catàlegs, contractes, polítiques — i responen amb fonts, sense inventar-se res.",
            whatH: "Què és RAG?",
            p1: "<strong>RAG</strong> són les sigles de <em>Retrieval-Augmented Generation</em> (generació augmentada per recuperació). És la tècnica que converteix un chatbot genèric en un assistent que coneix <strong>el teu</strong> negoci.",
            quote: "La manera més fàcil d'entendre-ho: un chatbot normal fa l'examen <em>de memòria</em>; un assistent amb RAG el fa <em>amb el teu llibre obert al davant</em>. Abans de respondre, busca als teus documents i redacta la resposta a partir del que hi troba.",
            p2: "ChatGPT o Claude \"a pèl\" saben molt del món en general, però no saben res dels teus preus, els teus terminis de lliurament, el teu conveni o el teu manual intern. I quan no saben una cosa, tendeixen a omplir el buit amb una resposta que <em>sona</em> bé — el que es coneix com a al·lucinació. En una empresa això és inacceptable: un preu inventat o una clàusula mal citada costen diners.",
            howH: "Com funciona",
            s1t: "S'indexen els teus documents",
            s1p: "Manuals, catàlegs, PDFs, webs, fulls de càlcul… es trossegen i es converteixen en representacions matemàtiques (embeddings) desades en una base de dades vectorial. Els teus documents no s'usen per entrenar models de tercers.",
            s2t: "Cada pregunta busca primer",
            s2p: "Quan algú pregunta, el sistema recupera els fragments dels teus documents més rellevants per a aquella pregunta concreta — encara que estigui formulada amb altres paraules.",
            s3t: "La IA respon amb fonts",
            s3p: "El model redacta la resposta usant només aquells fragments i pot citar de quin document i pàgina surt cada dada. Si la informació no existeix, diu que no la té en lloc d'inventar-la.",
            vsH: "Què aporta davant d'un chatbot normal",
            vsBadT: "❌ Chatbot genèric",
            vsBadList: "<li>Respon de memòria: pot inventar preus, terminis o polítiques.</li><li>No coneix el teu negoci ni els teus documents interns.</li><li>El seu coneixement es va congelar el dia que es va entrenar el model.</li><li>Impossible auditar d'on va sortir una resposta.</li>",
            vsGoodT: "✅ Assistent amb RAG",
            vsGoodList: "<li>Respon a partir dels teus documents reals, amb cita de la font.</li><li>Coneix el teu catàleg, les teves tarifes i els teus procediments al detall.</li><li>Canvia una tarifa? Puges el document nou i ja respon amb ell.</li><li>Cada resposta és traçable: saps quin document la respalda.</li>",
            benH: "Beneficis per a la teva empresa",
            b1t: "Respostes fiables",
            b1p: "Sense al·lucinacions: si no és als teus documents, l'assistent ho diu.",
            b2t: "Dades protegides",
            b2p: "La teva informació es consulta, no s'usa per entrenar models de tercers.",
            b3t: "Sempre actualitzat",
            b3p: "Actualitzar l'assistent és pujar un document — sense reentrenar res.",
            b4t: "Estalvi real de temps",
            b4p: "Les preguntes repetitives de clients i empleats es responen soles, 24/7.",
            b5t: "Multiidioma",
            b5p: "Els teus documents en castellà; respostes en català, francès o anglès.",
            b6t: "Amb fonts",
            b6p: "Cada resposta indica el document i l'apartat d'on surt.",
            casesH: "Casos d'ús típics",
            c1t: "Atenció al client",
            c1p: "Respon dubtes de productes, enviaments, devolucions i garanties consultant el teu catàleg i les teves polítiques reals.",
            c2t: "Assistent intern per a empleats",
            c2p: "\"Quants dies de vacances em queden segons el conveni?\" — resposta a l'instant consultant RRHH, manuals i procediments.",
            c3t: "Documentació legal i normativa",
            c3p: "Busca en contractes, normatives i pòlisses citant l'article exacte — en lloc de llegir 200 pàgines.",
            c4t: "Immobiliàries i catàlegs grans",
            c4p: "\"Pis de 2 habitacions amb terrassa per menys de 250.000€\" — busca a la teva cartera real i respon amb les fitxes.",
            c5t: "Formació i suport tècnic",
            ...
            rolesH: "Permisos per rol: cada empleat veu només el que li toca",
            rolesP1: "En carregar tota la documentació d'una empresa sorgeix la pregunta obligada: pot qualsevol empleat consultar qualsevol document? No. Cada document s'etiqueta amb els rols que poden veure'l — tothom, un departament, només direcció — i l'assistent respon a cada usuari únicament amb els documents del seu nivell d'accés.",
            rolesQ: "Mateixa pregunta — «Quina és la banda salarial de recepció?» — dues respostes diferents segons qui pregunta:",
            rolesA1t: "🛎️ Preguntant com a Recepció",
            rolesA1: "«Aquesta informació no és als documents disponibles per al teu rol.» L'informe de direcció ni tan sols arriba al model, així que no hi ha res que es pugui filtrar.",
            rolesA2t: "🔑 Preguntant com a Direcció",
            rolesA2: "«La banda salarial del personal de recepció va de 22.000 a 27.000 € bruts anuals…» — amb cita de l'informe intern que la respalda.",
            rolesP2: "La clau és on s'aplica el filtre: abans de la IA, a la mateixa cerca. El que un rol no pot veure mai entra al context del model, així que no se'l pot «convèncer» perquè ho reveli — no és una instrucció que es pugui saltar, és que no ho té. Els permisos es poden heretar dels que ja fas servir a Google Drive, SharePoint o la teva intranet, i cada consulta queda registrada per a auditoria. <a href=\"demo-rag.html\">Comprova-ho tu mateix a la demo canviant de rol</a>.",
...
about: {
        ...
        blog: {
            ...
            post1: {
                date: '24 juny 2026',
                excerpt: 'Rangs de preu reals, els factors que encareixen un projecte i com comparar pressupostos sense ensurts.',
                readMore: 'Llegir més →',
                title: 'Quant costa una app el 2026 (i de què depèn)',
            },
            post2: {
                date: '17 juny 2026',
                excerpt: 'Les tasques que el teu negoci repeteix a mà es poden fer soles. Aquestes són les que més temps retornen.',
                readMore: 'Llegir més →',
                title: 'Automatitzacions que estalvien hores cada setmana',
            },
            post3: {
                date: '10 juny 2026',
                excerpt: 'Instagram no és teu. El que una web pròpia aporta en reserves sense comissions i clients que sí que ho són.',
                readMore: 'Llegir més →',
                title: 'Per què el teu restaurant necessita web pròpia',
            },
            post4: {
                date: '3 juny 2026',
                excerpt: 'La meitat dels projectes comencen demanant el que no necessiten. Guia honesta per triar sense pagar de més.',
                readMore: 'Llegir més →',
                title: 'Web, app o programa a mida? Què necessites de debò',
            },
            post5: {
                date: '27 maig 2026',
                excerpt: "Cada reserva per Booking et costa fins a un 25%. El que fa que l'hoste reservi directament a la teva web.",
                readMore: 'Llegir més →',
                title: "Webs d'hotel que converteixen visites en reserves directes",
            },
            post6: {
                date: '20 maig 2026',
                excerpt: 'El comprador decideix què visitar des del sofà. Les eines digitals que marquen la diferència avui.',
                readMore: 'Llegir més →',
                title: 'Visites virtuals i IA: així es venen pisos el 2026',
            },
        },
        contact: {
            contactInfo: {
    ...
    fr: {
        ...
        rag: {
            tag: "// Projet",
            title: "RAG : l'IA qui répond <span class=\"text-gradient\">avec vos données</span>",
            subtitle: "Des assistants qui, avant de répondre, consultent les vrais documents de votre entreprise — manuels, catalogues, contrats, politiques — et répondent avec leurs sources, sans rien inventer.",
            whatH: "Qu'est-ce que le RAG ?",
            p1: "<strong>RAG</strong> signifie <em>Retrieval-Augmented Generation</em> (génération augmentée par récupération). C'est la technique qui transforme un chatbot générique en un assistant qui connaît <strong>votre</strong> entreprise.",
            quote: "La façon la plus simple de le comprendre : un chatbot classique passe l'examen <em>de mémoire</em> ; un assistant avec RAG le passe <em>avec votre livre ouvert devant lui</em>. Avant de répondre, il cherche dans vos documents et rédige la réponse à partir de ce qu'il trouve.",
            p2: "ChatGPT ou Claude « bruts » connaissent très bien le monde en général, mais ne savent rien de vos prix, de vos délais de livraison, de votre convention ou de votre manuel interne. Et quand ils ne savent pas, ils ont tendance à combler le vide avec une réponse qui <em>sonne</em> bien — ce qu'on appelle une hallucination. En entreprise, c'est inacceptable : un prix inventé ou une clause mal citée coûtent de l'argent.",
            howH: "Comment ça marche",
            s1t: "Vos documents sont indexés",
            s1p: "Manuels, catalogues, PDF, sites web, tableurs… ils sont découpés et convertis en représentations mathématiques (embeddings) stockées dans une base de données vectorielle. Vos documents ne servent pas à entraîner des modèles tiers.",
            s2t: "Chaque question cherche d'abord",
            s2p: "Quand quelqu'un pose une question, le système récupère les fragments de vos documents les plus pertinents pour cette question précise — même formulée avec d'autres mots.",
            s3t: "L'IA répond avec ses sources",
            s3p: "Le modèle rédige la réponse en utilisant uniquement ces fragments et peut citer le document et la page d'où provient chaque donnée. Si l'information n'existe pas, il le dit au lieu de l'inventer.",
            vsH: "Ce que ça apporte face à un chatbot classique",
            vsBadT: "❌ Chatbot générique",
            vsBadList: "<li>Répond de mémoire : peut inventer des prix, des délais ou des politiques.</li><li>Ne connaît ni votre entreprise ni vos documents internes.</li><li>Ses connaissances sont figées au jour de l'entraînement du modèle.</li><li>Impossible d'auditer d'où vient une réponse.</li>",
            vsGoodT: "✅ Assistant avec RAG",
            vsGoodList: "<li>Répond à partir de vos documents réels, en citant la source.</li><li>Connaît votre catalogue, vos tarifs et vos procédures en détail.</li><li>Un tarif change ? Vous téléversez le nouveau document et il répond avec.</li><li>Chaque réponse est traçable : vous savez quel document l'appuie.</li>",
            benH: "Les bénéfices pour votre entreprise",
            b1t: "Des réponses fiables",
            b1p: "Sans hallucinations : si ce n'est pas dans vos documents, l'assistant le dit.",
            b2t: "Des données protégées",
            b2p: "Vos informations sont consultées, pas utilisées pour entraîner des modèles tiers.",
            b3t: "Toujours à jour",
            b3p: "Mettre à jour l'assistant, c'est téléverser un document — sans rien réentraîner.",
            b4t: "Un vrai gain de temps",
            b4p: "Les questions répétitives des clients et des employés se répondent toutes seules, 24h/24.",
            b5t: "Multilingue",
            b5p: "Vos documents en espagnol ; des réponses en catalan, français ou anglais.",
            b6t: "Avec les sources",
            b6p: "Chaque réponse indique le document et la section d'où elle provient.",
            casesH: "Cas d'usage typiques",
            c1t: "Service client",
            c1p: "Répond aux questions sur les produits, livraisons, retours et garanties en consultant votre catalogue et vos politiques réelles.",
            c2t: "Assistant interne pour les employés",
            c2p: "« Combien de jours de congés me reste-t-il selon la convention ? » — réponse immédiate en consultant RH, manuels et procédures.",
            c3t: "Documentation juridique et réglementaire",
            c3p: "Cherche dans les contrats, réglementations et polices en citant l'article exact — au lieu de lire 200 pages.",
            c4t: "Immobilier et grands catalogues",
            c4p: "« Appartement 2 chambres avec terrasse à moins de 250 000 € » — cherche dans votre portefeuille réel et répond avec les fiches.",
            c5t: "Formation et support technique",
            ...
            rolesH: "Permissions par rôle : chaque employé ne voit que ce qui le concerne",
            rolesP1: "Quand on charge toute la documentation d'une entreprise, la question s'impose : n'importe quel employé peut-il consulter n'importe quel document ? Non. Chaque document est étiqueté avec les rôles autorisés à le voir — tout le monde, un service, la direction uniquement — et l'assistant répond à chaque utilisateur uniquement avec les documents de son niveau d'accès.",
            rolesQ: "Même question — « Quelle est la fourchette salariale de la réception ? » — deux réponses différentes selon qui demande :",
            rolesA1t: "🛎️ En demandant comme Réception",
            rolesA1: "« Cette information ne figure pas dans les documents disponibles pour votre rôle. » Le rapport de direction n'arrive même pas au modèle : rien ne peut donc fuiter.",
            rolesA2t: "🔑 En demandant comme Direction",
            rolesA2: "« La fourchette salariale du personnel de réception va de 22 000 à 27 000 € bruts annuels… » — avec la citation du rapport interne qui l'appuie.",
            rolesP2: "L'essentiel est l'endroit où le filtre s'applique : avant l'IA, dans la recherche elle-même. Ce qu'un rôle ne peut pas voir n'entre jamais dans le contexte du modèle : impossible de le « convaincre » de le révéler — ce n'est pas une consigne contournable, il ne l'a tout simplement pas. Les permissions peuvent hériter de celles que vous utilisez déjà dans Google Drive, SharePoint ou votre intranet, et chaque requête est journalisée pour audit. <a href=\"demo-rag.html\">Vérifiez-le vous-même dans la démo en changeant de rôle</a>.",
...
about: {
        ...
        blog: {
            ...
            post1: {
                date: '24 juin 2026',
                excerpt: 'Des fourchettes de prix réelles, les facteurs qui font grimper un projet et comment comparer les devis sans surprise.',
                readMore: 'Lire la suite →',
                title: 'Combien coûte une app en 2026 (et de quoi ça dépend)',
            },
            post2: {
                date: '17 juin 2026',
                excerpt: 'Les tâches que votre entreprise répète à la main peuvent se faire toutes seules. Voici celles qui rapportent le plus de temps.',
                readMore: 'Lire la suite →',
                title: 'Des automatisations qui font gagner des heures chaque semaine',
            },
            post3: {
                date: '10 juin 2026',
                excerpt: "Instagram ne vous appartient pas. Ce qu'un site à vous apporte : des réservations sans commission et des clients qui sont les vôtres.",
                readMore: 'Lire la suite →',
                title: 'Pourquoi votre restaurant a besoin de son propre site',
            },
            post4: {
                date: '3 juin 2026',
                excerpt: "La moitié des projets commencent par demander ce dont ils n'ont pas besoin. Un guide honnête pour bien choisir.",
                readMore: 'Lire la suite →',
                title: "Site web, appli ou logiciel sur mesure ? Ce qu'il vous faut vraiment",
            },
            post5: {
                date: '27 mai 2026',
                excerpt: "Chaque réservation via Booking vous coûte jusqu'à 25%. Ce qui pousse le client à réserver en direct sur votre site.",
                readMore: 'Lire la suite →',
                title: "Des sites d'hôtel qui transforment les visites en réservations directes",
            },
            post6: {
                date: '20 mai 2026',
                excerpt: "L'acheteur décide quoi visiter depuis son canapé. Les outils numériques qui font la différence aujourd'hui.",
                readMore: 'Lire la suite →',
                title: 'Visites virtuelles et IA : voilà comment on vend des appartements en 2026',
            },
        },
        contact: {
            contactInfo: {
    ...
    en: {
        ...
        rag: {
            tag: "// Project",
            title: "RAG: AI that answers <span class=\"text-gradient\">with your data</span>",
            subtitle: "Assistants that check your company's real documents before answering — manuals, catalogs, contracts, policies — and reply with sources, without making anything up.",
            whatH: "What is RAG?",
            p1: "<strong>RAG</strong> stands for <em>Retrieval-Augmented Generation</em>. It's the technique that turns a generic chatbot into an assistant that knows <strong>your</strong> business.",
            quote: "The easiest way to understand it: a regular chatbot takes the exam <em>from memory</em>; a RAG assistant takes it <em>with your book open in front of it</em>. Before answering, it searches your documents and writes the answer from what it finds.",
            p2: "Plain ChatGPT or Claude know a lot about the world in general, but nothing about your prices, delivery times, agreements or internal manuals. And when they don't know something, they tend to fill the gap with an answer that <em>sounds</em> right — known as a hallucination. In a business that's unacceptable: a made-up price or a misquoted clause costs money.",
            howH: "How it works",
            s1t: "Your documents get indexed",
            s1p: "Manuals, catalogs, PDFs, websites, spreadsheets… they are chunked and converted into mathematical representations (embeddings) stored in a vector database. Your documents are not used to train third-party models.",
            s2t: "Every question searches first",
            s2p: "When someone asks, the system retrieves the fragments of your documents most relevant to that specific question — even if it's phrased differently.",
            s3t: "The AI answers with sources",
            s3p: "The model writes the answer using only those fragments and can cite which document and page each fact comes from. If the information doesn't exist, it says so instead of inventing it.",
            vsH: "What it delivers vs a regular chatbot",
            vsBadT: "❌ Generic chatbot",
            vsBadList: "<li>Answers from memory: it can invent prices, deadlines or policies.</li><li>Knows nothing about your business or internal documents.</li><li>Its knowledge froze the day the model was trained.</li><li>Impossible to audit where an answer came from.</li>",
            vsGoodT: "✅ RAG assistant",
            vsGoodList: "<li>Answers from your real documents, citing the source.</li><li>Knows your catalog, rates and procedures in detail.</li><li>A rate changes? Upload the new document and it answers with it.</li><li>Every answer is traceable: you know which document backs it.</li>",
            benH: "Benefits for your business",
            b1t: "Reliable answers",
            b1p: "No hallucinations: if it's not in your documents, the assistant says so.",
            b2t: "Protected data",
            b2p: "Your information is queried, not used to train third-party models.",
            b3t: "Always up to date",
            b3p: "Updating the assistant means uploading a document — no retraining.",
            b4t: "Real time savings",
            b4p: "Repetitive questions from customers and employees answer themselves, 24/7.",
            b5t: "Multi-language",
            b5p: "Your documents in Spanish; answers in Catalan, French or English.",
            b6t: "With sources",
            b6p: "Every answer points to the document and section it comes from.",
            casesH: "Typical use cases",
            c1t: "Customer support",
            c1p: "Answers questions about products, shipping, returns and warranties by checking your real catalog and policies.",
            c2t: "Internal assistant for employees",
            c2p: "\"How many vacation days do I have left under the agreement?\" — instant answer from HR docs, manuals and procedures.",
            c3t: "Legal and regulatory documentation",
            c3p: "Searches contracts, regulations and policies citing the exact clause — instead of reading 200 pages.",
            c4t: "Real estate and large catalogs",
            c4p: "\"2-bedroom flat with a terrace under €250,000\" — searches your real portfolio and replies with the listings.",
            c5t: "Training and technical support",
            ...
            rolesH: "Role-based permissions: every employee sees only what they should",
            rolesP1: "When you load a company's entire documentation, the obvious question follows: can any employee query any document? No. Each document is tagged with the roles allowed to see it — everyone, one department, management only — and the assistant answers each user using only the documents at their access level.",
            rolesQ: "Same question — \"What is the reception salary band?\" — two different answers depending on who asks:",
            rolesA1t: "🛎️ Asking as Reception",
            rolesA1: "\"That information is not in the documents available to your role.\" The management report never even reaches the model, so there is nothing that could leak.",
            rolesA2t: "🔑 Asking as Management",
            rolesA2: "\"The reception salary band ranges from €22,000 to €27,000 gross per year…\" — with a citation to the internal report backing it.",
            rolesP2: "What matters is where the filter is applied: before the AI, in the retrieval itself. What a role cannot see never enters the model's context, so it cannot be \"talked into\" revealing it — it is not an instruction to bypass, the model simply does not have it. Permissions can be inherited from the ones you already use in Google Drive, SharePoint or your intranet, and every query is logged for auditing. <a href=\"demo-rag.html\">Check it yourself in the demo by switching roles</a>.",
...
about: {
        ...
        blog: {
            ...
            post1: {
                date: 'Jun 24, 2026',
                excerpt: 'Real price ranges, the factors that drive a project up and how to compare quotes without surprises.',
                readMore: 'Read more →',
                title: 'How much an app costs in 2026 (and what it depends on)',
            },
            post2: {
                date: 'Jun 17, 2026',
                excerpt: 'The tasks your business repeats by hand can run on their own. These are the ones that give back the most time.',
                readMore: 'Read more →',
                title: 'Automations that save hours every week',
            },
            post3: {
                date: 'Jun 10, 2026',
                excerpt: "Instagram isn't yours. What your own website brings: commission-free bookings and customers that belong to you.",
                readMore: 'Read more →',
                title: 'Why your restaurant needs its own website',
            },
            post4: {
                date: 'Jun 3, 2026',
                excerpt: 'Half of all projects start by asking for the wrong thing. An honest guide to choosing without overpaying.',
                readMore: 'Read more →',
                title: 'Website, app or custom software? What you actually need',
            },
            post5: {
                date: 'May 27, 2026',
                excerpt: 'Every Booking reservation costs you up to 25%. What makes guests book directly on your website.',
                readMore: 'Read more →',
                title: 'Hotel websites that turn visits into direct bookings',
            },
            post6: {
                date: 'May 20, 2026',
                excerpt: 'Buyers decide what to visit from their sofa. The digital tools that make the difference today.',
                readMore: 'Read more →',
                title: 'Virtual tours and AI: how homes are sold in 2026',
            },
        },
        contact: {
            contactInfo: {
